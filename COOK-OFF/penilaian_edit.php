...
$update = "UPDATE peserta SET NoKP = '$nokp', NamaPeserta = '$nama', Katalaluan = '$passwd'
              jantina = '$jantina', No Telefon = '$telefon' WHERE NoKP = '$nokp' ";
...
echo "<script>alert('Penilaian peserta berjaya');
             window.location = 'senarai_penialian.php'</script>";
}
?>

...
$data = "INSERT INTO pertandingan(NoKP,IDPenilaian,IDHakim,Tarikh,skor)
          VALUES ('$nokp','$idpenilaian','$idhakim','$tarikh','$skor')";
...
$sql = mysql_query($con, "SELECT * FROM peserta WHERE NoKP = $pesertaEdit");
